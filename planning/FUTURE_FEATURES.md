...
- [x] Solo mode disconnect timeout is too aggressive (30 seconds). Since no one is waiting, solo players should have a longer timeout (e.g., 30 minutes) to allow returning to a game after being distracted.
