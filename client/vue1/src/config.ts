...
// Construct base URLs
export const config = {
  // Base URL for HTTP/Connect-RPC calls (e.g., 'http://localhost:8080' or 'http://localhost:8080/api')
  httpBaseUrl: `http://${serverHost}:${serverPort}${basePath}`,

  // Base URL for WebSocket connections (e.g., 'ws://localhost:8080/ws' or 'ws://localhost:8080/api/ws')
  wsUrl: `ws://${serverHost}:${serverPort}${basePath}/ws`,
}
