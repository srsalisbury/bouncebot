...
func TestBFSSolver_Name(t *testing.T) {
	s := &BFSSolver{}
	if s.Name() != "bfs2" {
		t.Errorf("expected name 'bfs2', got '%s'", s.Name())
	}
}

func TestBFSSolver_AlreadySolved(t *testing.T) {
	s := &BFSSolver{}
	game := model.Game1()
...
func TestBFSSolver_FindsSolution(t *testing.T) {
	s := &BFSSolver{}
	game := model.Game1()
...
func TestBFSSolver_Timeout(t *testing.T) {
	s := &BFSSolver{}
	game := model.Game1()
...
func TestBFSSolver_OptimalSolution(t *testing.T) {
	s := &BFSSolver{}
	game := model.Game1()
